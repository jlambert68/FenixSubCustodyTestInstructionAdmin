...
const (
	...
	TestApiEngine_AttributeName_UUID_FenixGeneral_SendTestDataToThisDomain_ChosenTestDataAsJsonString  TestApiEngine_AttributeName_UUID_SubCustody_Type = "30f7db3f-e6da-4fdf-bf5d-83c77c1d2b23"
	TestApiEngine_AttributeName_Name_SFenixGeneral_SendTestDataToThisDomain_ChosenTestDataAsJsonString TestApiEngine_AttributeName_Name_SubCustody_Type = "ChosenTestDataAsJsonString"

	// ClassName - ***** 'VerifyMQTypeMT' *****
	...
	TestApiEngine_AttributeName_Name_SubCustody_VerifyMQMessageTypeMT_RelatedReference_5xx_20CRELA TestApiEngine_AttributeName_Name_SubCustody_Type = "RelatedReference_5xx_20CRELA"

	// ClassName:'VerifyMQTypeMT' - MethodName: 'VerifyContentTypeMT5xx' - Attributes
	TestApiEngine_AttributeName_UUID_SubCustody_VerifyContentTypeMT5xx_MessageType_5xx TestApiEngine_AttributeName_UUID_SubCustody_Type = "e759ccde-20ee-4191-b7be-c902832f61d6"
	TestApiEngine_AttributeName_Name_SubCustody_VerifyContentTypeMT5xx_MessageType_5xx TestApiEngine_AttributeName_Name_SubCustody_Type = "RelatedReference_MessageType_5xx"
)
